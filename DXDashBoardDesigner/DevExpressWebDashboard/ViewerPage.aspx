...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dx:ASPxDashboard ID="ASPxDashboard1" runat="server"  Width="100%" Height="100%" DashboardStorageFolder="~/App_Data/Dashboards" LimitVisibleDataMode="DesignerAndViewer" WorkingMode="ViewerOnly" LoadDefaultDashboard="False" OnDashboardLoading="ASPxDashboard1_DashboardLoading">
        <PdfExportOptions PageLayout="Landscape" />
    </dx:ASPxDashboard>
</asp:Content>
